class HomeController < ApplicationController
  ...
  def analysis
    ...
    for bet in @horse_broome
      ...
      @roi_broome = (@pnl_broome / @total_broome).round(2)
    end
    ...
    for bet in @horse_geelong
      ...
      @roi_geelong = (@pnl_geelong / @total_geelong).round(2)
    end
    ...
    for bet in @horse_taree
      ...
      @roi_taree = (@pnl_taree / @total_taree).round(2)
    end
    ...
    for bet in @horse_murraybridge
      ...
      @roi_murraybridge = (@pnl_murraybridge / @total_murraybridge).round(2)
    end
    ...
    for bet in @horse_gosford
      ...
      @roi_gosford = (@pnl_gosford / @total_gosford).round(2)
    end
    ...
    for bet in @horse_moree
      ...
      @roi_moree = (@pnl_moree / @total_moree).round(2)
    end
    ...
    for bet in @horse_pinjarra
      ...
      @roi_pinjarra = (@pnl_pinjarra / @total_pinjarra).round(2)
    end
    ...
    for bet in @horse_rockhampton
      ...
      @roi_rockhampton = (@pnl_rockhampton / @total_rockhampton).round(2)
    end
    ...
    for bet in @horse_sale
      ...
      @roi_sale = (@pnl_sale / @total_sale).round(2)
    end
    ...
    for bet in @horse_belmont
      ...
      @roi_belmont = (@pnl_belmont / @total_belmont).round(2)
    end
    ...
    for bet in @horse_cessnock
      ...
      @roi_cessnock = (@pnl_cessnock / @total_cessnock).round(2)
    end
    ...
    for bet in @horse_dalby
      ...
      @roi_dalby = (@pnl_dalby / @total_dalby).round(2)
    end
    ...
    for bet in @horse_alicesprings
      ...
      @roi_alicesprings = (@pnl_alicesprings / @total_alicesprings).round(2)
    end
    ...
    for bet in @horse_grafton
      ...
      @roi_grafton = (@pnl_grafton / @total_grafton).round(2)
    end
    ...
    for bet in @horse_kalgoorlie
      ...
      @roi_kalgoorlie = (@pnl_kalgoorlie / @total_kalgoorlie).round(2)
    end
    ...
    for bet in @horse_wodonga
      ...
      @roi_wodonga = (@pnl_wodonga / @total_wodonga).round(2)
    end
    ...
    for bet in @horse_carnarvon
      ...
      @roi_carnarvon = (@pnl_carnarvon / @total_carnarvon).round(2)
    end
    ...
    for bet in @horse_caulfield
      ...
      @roi_caulfield = (@pnl_caulfield / @total_caulfield).round(2)
    end
    ...
    for bet in @horse_darwin
      ...
      @roi_darwin = (@pnl_darwin / @total_darwin).round(2)
    end
    ...
    for bet in @horse_eaglefarm
      ...
      @roi_eaglefarm = (@pnl_eaglefarm / @total_eaglefarm).round(2)
    end
    ...
    for bet in @horse_echuca
      ...
      @roi_echuca = (@pnl_echuca / @total_echuca).round(2)
    end
    ...
    for bet in @horse_gawler
      ...
      @roi_gawler = (@pnl_gawler / @total_gawler).round(2)
    end
    ...
    for bet in @horse_kembla
      ...
      @roi_kembla = (@pnl_kembla / @total_kembla).round(2)
    end
    ...
    for bet in @horse_rosehill
      ...
      @roi_rosehill = (@pnl_rosehill / @total_rosehill).round(2)
    end
    ...
    for bet in @horse_townsville
      ...
      @roi_townsville = (@pnl_townsville / @total_townsville).round(2)
    end
    ...
    for bet in @horse_tuncurry
      ...
      @roi_tuncurry = (@pnl_tuncurry / @total_tuncurry).round(2)
    end
    ...
    for bet in @horse_cranbourne
      ...
      @roi_cranbourne = (@pnl_cranbourne / @total_cranbourne).round(2)
    end
    ...
    for bet in @horse_northam
      ...
      @roi_northam = (@pnl_northam / @total_northam).round(2)
    end
    ...
    for bet in @horse_devonport
      ...
      @roi_devonport = (@pnl_devonport / @total_devonport).round(2)
    end
    ...
    for bet in @horse_doomben
      ...
      @roi_doomben = (@pnl_doomben / @total_doomben).round(2)
    end
    ...
    for bet in @horse_flemington
      ...
      @roi_flemington = (@pnl_flemington / @total_flemington).round(2)
    end
    ...
    for bet in @horse_goldcoast
      ...
      @roi_goldcoast = (@pnl_goldcoast / @total_goldcoast).round(2)
    end
    ...
    for bet in @horse_morphettville
      ...
      @roi_morphettville = (@pnl_morphettville / @total_morphettville).round(2)
    end
    ...
    for bet in @horse_randwick
      ...
      @roi_randwick = (@pnl_randwick / @total_randwick).round(2)
    end
    ...
    for bet in @horse_toowoomba
      ...
      @roi_toowoomba = (@pnl_toowoomba / @total_toowoomba).round(2)
    end
    ...
    for bet in @horse_ipswich
      ...
      @roi_ipswich = (@pnl_ipswich / @total_ipswich).round(2)
    end
    ...
    for bet in @horse_scone
      ...
      @roi_scone = (@pnl_scone / @total_scone).round(2)
    end
    ...
    for bet in @horse_hawkesbury
      ...
      @roi_hawkesbury = (@pnl_hawkesbury / @total_hawkesbury).round(2)
    end
    ...
    for bet in @horse_mackay
      ...
      @roi_mackay = (@pnl_mackay / @total_mackay).round(2)
    end
    ...
    for bet in @horse_canterbury
      ...
      @roi_canterbury = (@pnl_canterbury / @total_canterbury).round(2)
    end
    ...
    for bet in @horse_sandown
      ...
      @roi_sandown = (@pnl_sandown / @total_sandown).round(2)
    end
    ...
    for bet in @horse_corowa
      ...
      @roi_corowa = (@pnl_corowa / @total_corowa).round(2)
    end
    ...
    for bet in @horse_mildura
      ...
      @roi_mildura = (@pnl_mildura / @total_mildura).round(2)
    end
    ...
    for bet in @horse_bordertown
      ...
      @roi_bordertown = (@pnl_bordertown / @total_bordertown).round(2)
    end
    ...
    for bet in @horse_casterton
      ...
      @roi_casterton = (@pnl_casterton / @total_casterton).round(2)
    end
    ...
    for bet in @horse_launceston
      ...
      @roi_launceston = (@pnl_launceston / @total_launceston).round(2)
    end
    ...
    for bet in @horse_mudgee
      ...
      @roi_mudgee = (@pnl_mudgee / @total_mudgee).round(2)
    end

    @horse_sapphirecoast = @bets.where("sport = ? AND game like ?", 7, "%Sapphire Soast%")
    ...
    for bet in @horse_sapphirecoast
      ...
      @roi_sapphirecoast = (@pnl_sapphirecoast / @total_sapphirecoast).round(2)
    end
    ...
    for bet in @horse_donald
      ...
      @roi_donald = (@pnl_donald / @total_donald).round(2)
    end
    ...
    for bet in @horse_muswellbrook
      ...
      @roi_muswellbrook = (@pnl_muswellbrook / @total_muswellbrook).round(2)
    end
    ...
    for bet in @horse_wyong
      ...
      @roi_wyong = (@pnl_wyong / @total_wyong).round(2)
    end
    ...
    for bet in @horse_bendigo
      ...
      @roi_bendigo = (@pnl_bendigo / @total_bendigo).round(2)
    end
